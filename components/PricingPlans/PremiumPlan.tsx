  ...
  return (
    <div className="size-full flex items-center justify-center">
      <div className="w-full h-full lg:h-[780px] flex flex-col items-start justify-between gap-5 text-white-main font-dmSans bg-brand-main shadow-lg rounded-[40px] p-8 lg:px-8 py-16 relative">
        ...
        <button className="w-full mt-2 flex-shrink-0 sm:h-[72px] h-[60px] text-brand-main text-base font-bold sm:text-lg flex items-center justify-center bg-white-main rounded-[40px]">
          Get started
        </button>
      </div>
    </div>
